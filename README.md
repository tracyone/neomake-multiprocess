# neomake-multiprocess [![Build Status](https://travis-ci.org/tracyone/neomakmp-multiprocess.svg?branch=master)](https://travis-ci.org/tracyone/neomakmp-multiprocess)
